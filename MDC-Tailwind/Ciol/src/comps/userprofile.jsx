...
import Logo from "../assets/MDC.png"
            ...
            <span className="flex w-full items-center justify-between">
              <span className="flex min-w-0 items-center justify-between space-x-3">
                ...
                <span className="flex min-w-0 flex-1 flex-col">
                  <span className="truncate text-sm font-medium text-gray-900">Mdc User</span>
                  <span className="truncate text-sm text-gray-500">MdcUser000@mymdc.net</span>
                </span>
              </span>
              <ChevronUpDownIcon
